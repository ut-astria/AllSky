...
void pass_prediction()
{
	...
	*/
						...
						for (double MJD_pass = temp_pass_start_MJD; MJD_pass <= temp_pass_stop_MJD; MJD_pass += pass_fine_search_step_day)
						{
							...
							else
							{
								...
								if ((SunlitStart_MJD >= temp_pass_start_MJD) && ((SunlitStop_MJD - SunlitStart_MJD) >= pass_duration_min_day))
								{
									...
									float el_max = 0.;									
									Pass_track_topo_rad.push_back(std::vector<aef>());
									int pass_number = Pass_track_topo_rad.size() - 1;
									Pass_track_topo_rad[pass_number].resize(0);
									...
									sat_pass_calculate_track(
										...
										search_step_s,
										&Pass_track_topo_rad[pass_number],
										&el_max
									);
	...
	plot_pass_topo_radial(&Pass_start_MJD, &Pass_track_topo_rad);
